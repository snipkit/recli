(function (global, factory) {
    ...
    (factory((global.KhulnasoftReact = {})));
    ...
    ***************************************************************************** */
    ...
    var sessionStorageKey = 'khulnasoftSessionId';
    var isBrowser = typeof window !== 'undefined';
    var isIframe = isBrowser && window.top !== window.self;
    var Khulnasoft = /** @class */ (function () {
        function Khulnasoft(apiKey) {
            ...
            this.testCookiePrefix = 'khulnasoft.tests';
            this.cookieQueue = [];
            if (apiKey) {
                this.apiKey = apiKey;
            }
            if (isBrowser) {
                ...
                window.KHULNASOFT_VERSION = Khulnasoft.VERSION;
            }
            if (isIframe) {
        ...
        Khulnasoft.fields = function (name$$1, fields) {
            window.parent.postMessage({
                type: 'khulnasoft.fields',
                data: { name: name$$1, fields: fields },
            }, '*');
        };
        Object.defineProperty(Khulnasoft, "editingPage", {
            // useCdnApi = false;
            get: function () {
        ...
        Khulnasoft.prepareComponentSpecToSend = function (spec) {
        ...
        Khulnasoft.component = function (info) {
            var _this = this;
            if (info === void 0) { info = {}; }
        ...
        Object.defineProperty(Khulnasoft, "Component", {
            get: function () {
        ...
        Khulnasoft.prototype.processEventsQueue = function () {
        ...
        Object.defineProperty(Khulnasoft.prototype, "browserTrackingDisabled", {
            get: function () {
                return Khulnasoft.isBrowser && navigator.doNotTrack === '1';
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Khulnasoft.prototype, "canTrack", {
            get: function () {
        ...
        Object.defineProperty(Khulnasoft.prototype, "editingMode", {
            get: function () {
        ...
        Object.defineProperty(Khulnasoft.prototype, "editingModel", {
            get: function () {
        ...
        Khulnasoft.prototype.findParentElement = function (target, callback, checkElement) {
        ...
        Khulnasoft.prototype.findKhulnasoftParent = function (target) {
            return this.findParentElement(target, function (el) {
                var id = el.getAttribute('khulnasoft-id') || el.id;
                return Boolean(id && id.indexOf('khulnasoft-') === 0);
            });
        };
        Khulnasoft.prototype.setUserAgent = function (userAgent) {
            this.userAgent = userAgent;
        };
        Khulnasoft.prototype.track = function (eventName, properties) {
        ...
        Khulnasoft.prototype.getSessionId = function () {
            var _this = this;
            // TODO: don't set this until gdpr allowed....
            var sessionId = (Khulnasoft.isBrowser &&
        ...
        Khulnasoft.prototype.trackImpression = function (contentId, variationId) {
            if (isIframe || !isBrowser) {
                return;
            }
        ...
        Object.defineProperty(Khulnasoft.prototype, "isDevelopmentEnv", {
            // TODO: set this for QA
            get: function () {
                // Automatic determining of development environment
                return (Khulnasoft.isIframe ||
        ...
        Khulnasoft.prototype.trackInteraction = function (contentId, variationId, alreadyTrackedOne, event) {
            if (alreadyTrackedOne === void 0) { alreadyTrackedOne = false; }
            if (isIframe || !isBrowser) {
                return;
            }
            var target = event && event.target;
            var targetKhulnasoftElement = target && this.findKhulnasoftParent(target);
            function round(num) {
            ...
            if (event) {
                ...
                if (targetKhulnasoftElement) {
                    var targetRect = targetKhulnasoftElement.getBoundingClientRect();
                    var xOffset = clientX - targetRect.left;
                    var yOffset = clientY - targetRect.top;
                    var xRatio = round(xOffset / targetRect.width);
                    var yRatio = round(yOffset / targetRect.height);
            ...
            //   }
            // }
            var khulnasoftId = targetKhulnasoftElement &&
        ...
        Khulnasoft.prototype.component = function (info) {
            if (info === void 0) { info = {}; }
            return Khulnasoft.component(info);
        };
        Object.defineProperty(Khulnasoft.prototype, "apiKey", {
            get: function () {
        ...
        Khulnasoft.prototype.modifySearch = function (search) {
            return search.replace(/(^|&|\?)(khulnasoft_.*?)=/gi, function (_match, group1, group2) { return group1 + group2.replace(/_/g, '.') + '='; });
        };
        Khulnasoft.prototype.setTestsFromUrl = function () {
            var search = this.getLocation().search;
            var params = QueryString.parseDeep(this.modifySearch(search || '').substr(1));
            var tests = params.khulnasoft && params.khulnasoft.tests;
        ...
        Khulnasoft.prototype.getOverridesFromQueryString = function () {
            var location = this.getLocation();
            var params = QueryString.parseDeep(this.modifySearch(location.search || '').substr(1));
            var khulnasoft = params.khulnasoft;
            if (khulnasoft) {
                var userAttributes = khulnasoft.userAttributes, overrides = khulnasoft.overrides, env = khulnasoft.env, host = khulnasoft.host, api = khulnasoft.api, cachebust = khulnasoft.cachebust, noCache = khulnasoft.noCache, preview = khulnasoft.preview;
                if (userAttributes) {
        ...
        Khulnasoft.prototype.messageFrameLoaded = function () {
            window.parent.postMessage({
        ...
        Khulnasoft.prototype.bindMessageListeners = function () {
            var _this = this;
            if (isBrowser) {
                addEventListener('message', function (event) {
                    var url = parse(event.origin);
                    var allowedHosts = ['khulnasoft.com', 'localhost', 'local.khulnasoft.com', 'qa.khulnasoft.com'];
                        ...
                        switch (data.type) {
                            ...
                            case 'khulnasoft.getComponents':
                                window.parent.postMessage({
                                    ...
                                    data: Khulnasoft.components.map(function (item) { return Khulnasoft.prepareComponentSpecToSend(item); }),
                                }, '*');
                                break;
                            ...
                            case 'khulnasoft.registerComponent':
                                ...
                                Khulnasoft.components.push(componentData);
                                break;
        ...
        Khulnasoft.prototype.init = function (apiKey, canTrack) {
        ...
        Khulnasoft.prototype.getLocation = function () {
            return (typeof location === 'object' && parse(location.href)) || {};
        };
        Khulnasoft.prototype.getUserAttributes = function (userAgent) {
            ...
            return __assign({ queryString: url.search, urlPath: url.pathname, 
                ...
                device: isMobile.any() ? 'mobile' : 'desktop' }, Khulnasoft.overrideUserAttributes);
        };
        Khulnasoft.prototype.setUserAttributes = function (options) {
            assign(Khulnasoft.overrideUserAttributes, options);
        };
        Khulnasoft.prototype.get = function (modelName, options) {
            if (options === void 0) { options = {}; }
        ...
        Khulnasoft.prototype.queueGetContent = function (modelName, options) {
            var _this = this;
            if (options === void 0) { options = {}; }
        ...
        Khulnasoft.prototype.requestUrl = function (url) {
            return fetch$1(url).then(function (res) { return res.json(); });
        };
        Object.defineProperty(Khulnasoft.prototype, "host", {
            get: function () {
        ...
        Khulnasoft.prototype.flushGetContentQueue = function (usePastQueue, useQueue) {
            var _this = this;
            if (usePastQueue === void 0) { usePastQueue = false; }
            if (!this.apiKey) {
                throw new Error('Khulnasoft needs to be initialized with an API key!');
            }
            ...
            queryParams.userAttributes = Khulnasoft.useNewApi
                ? userAttributes
            ...
            var host = this.useNewContentApi ? 'https://lambda.khulnasoft.codes' : this.host;
            var modelNames = queue.map(function (item) { return item.model; }).join(',');
            var queryStr = Khulnasoft.useNewApi
                ? QueryString.stringifyDeep(queryParams)
                : QueryString.stringify(queryParams);
            var promise = this.requestUrl(host + "/api/v1/" + (Khulnasoft.useNewApi ? 'query' : 'content') + "/" + this.apiKey + "/" + modelNames +
        ...
        Khulnasoft.prototype.processResultsForTests = function (results) {
            var _this = this;
            ...
            if (isIframe) {
                window.parent.postMessage({ type: 'khulnasoft.contentResults', data: { results: mappedResults } }, '*');
            }
            return mappedResults;
        };
        Khulnasoft.prototype.getTestCookie = function (contentId) {
            return this.getCookie(this.testCookiePrefix + "." + contentId);
        };
        Khulnasoft.prototype.setTestCookie = function (contentId, variationId) {
            if (!this.canTrack) {
        ...
        Khulnasoft.prototype.getCookie = function (name$$1) {
            return getCookie(name$$1);
        };
        Khulnasoft.prototype.setCookie = function (name$$1, value, expires) {
            return setCookie(name$$1, value, expires);
        };
        Khulnasoft.prototype.getContent = function (modelName, options) {
            if (options === void 0) { options = {}; }
            if (!this.apiKey) {
                throw new Error('Khulnasoft needs to be initialized with an API key!');
            }
        ...
        Khulnasoft.nextTick = nextTick;
        Khulnasoft.VERSION = version;
        Khulnasoft.useNewApi = true;
        Khulnasoft.animator = new Animator();
        Khulnasoft._editingPage = false;
        Khulnasoft.isIframe = isIframe;
        Khulnasoft.isBrowser = isBrowser;
        Khulnasoft.isReact = false;
        Khulnasoft.overrideUserAttributes = {};
        return Khulnasoft;
    }());

    // import 'promise-polyfill/src/polyfill';
    var khulnasoft = new Khulnasoft();
    ...
    */
    ...
    function KhulnasoftBlock(options) {
        options.type = 'react';
        return Khulnasoft.Component(options);
    }

    var KhulnasoftCanvasComponent = /** @class */ (function (_super) {
        __extends(KhulnasoftCanvasComponent, _super);
        function KhulnasoftCanvasComponent() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        KhulnasoftCanvasComponent.prototype.render = function () {
            return (react.createElement("div", { className: "khulnasoft-content-canvas", style: {
                    display: 'flex',
        ...
        KhulnasoftCanvasComponent = __decorate([
            KhulnasoftBlock({
                name: 'Canvas',
                ...
                inputs: [
                    {
                        ...
                        defaultValue: "\n        <div\n          style=\"pointer-events: none;position: absolute;background-position: center;background-repeat: no-repeat;background-size: contain;width: 568px;height: 330px;background-image: url(https://khulnasoft.com/api/v1/image/assets%2FKQlEmWDxA0coC3PK6UvkrjwkIGI2%2Ffe466c3c1acf48c58d32960128825fd8);top: 43.015625px;left: 50%;margin-left: -269px;\"\n          khulnasoft-responsive-styles=\"{&quot;large&quot;:{&quot;position&quot;:&quot;absolute&quot;,&quot;backgroundPosition&quot;:&quot;center&quot;,&quot;backgroundRepeat&quot;:&quot;no-repeat&quot;,&quot;backgroundSize&quot;:&quot;contain&quot;,&quot;width&quot;:&quot;568px&quot;,&quot;height&quot;:&quot;330px&quot;,&quot;backgroundImage&quot;:&quot;url(https://khulnasoft.com/api/v1/image/assets%2FKQlEmWDxA0coC3PK6UvkrjwkIGI2%2Ffe466c3c1acf48c58d32960128825fd8)&quot;,&quot;top&quot;:&quot;43.015625px&quot;,&quot;left&quot;:&quot;50%&quot;,&quot;marginLeft&quot;:&quot;-269px&quot;},&quot;medium&quot;:{},&quot;small&quot;:{},&quot;xsmall&quot;:{}}\">\n        </div>\n        <div\n          style=\"pointer-events: none;display: flex;position: absolute;background-size: contain;background-position: center;background-repeat: no-repeat;justify-content: center;text-align: center;background-color: ;top: 167.015625px;left: 50%;margin-left: -140px;width: 318px;height: 83px;font-size: 26px;\"\n          khulnasoft-responsive-styles=\"{&quot;large&quot;:{&quot;display&quot;:&quot;flex&quot;,&quot;position&quot;:&quot;absolute&quot;,&quot;backgroundSize&quot;:&quot;contain&quot;,&quot;backgroundPosition&quot;:&quot;center&quot;,&quot;backgroundRepeat&quot;:&quot;no-repeat&quot;,&quot;justifyContent&quot;:&quot;center&quot;,&quot;textAlign&quot;:&quot;center&quot;,&quot;backgroundColor&quot;:&quot;&quot;,&quot;top&quot;:&quot;167.015625px&quot;,&quot;left&quot;:&quot;50%&quot;,&quot;marginLeft&quot;:&quot;-140px&quot;,&quot;width&quot;:&quot;318px&quot;,&quot;height&quot;:&quot;83px&quot;,&quot;fontSize&quot;:&quot;26px&quot;},&quot;medium&quot;:{},&quot;small&quot;:{},&quot;xsmall&quot;:{}}\">\n          You can draw any content you like here!\n        </div>\n        <div\n          style=\"height: 400px;z-index: 0;position: relative;pointer-events: none;\"data-khulnasoft-artboard=\"true\"\n          data-artboard-heights=\"{&quot;large&quot;:400,&quot;medium&quot;:null,&quot;small&quot;:null,&quot;xsmall&quot;:null}\">\n        </div>\n      ",
                    },
                ],
            })
        ], KhulnasoftCanvasComponent);
        return KhulnasoftCanvasComponent;
    }(react.Component));
    ...
    var ContentColumnsComponent = /** @class */ (function (_super) {
        ...
        function ContentColumnsComponent() {
            ...
            _this.gutterSize = 15;
            _this.isBrowser = Khulnasoft.isBrowser;
            return _this;
        }
        ...
        ContentColumnsComponent.prototype.render = function () {
            ...
            return (react.createElement(Fragment, null,
                react.createElement("style", { className: "khulnasoft-style khulnasoft-style-content-columns" }, "\n          .khulnasoft-content-columns a:not([href]) {\n            cursor: default;\n          }\n          .khulnasoft-content-columns {\n            display: flex;\n            flex-direction: column;\n          }\n          @media (min-width: 500px) {\n            .khulnasoft-content-columns {\n              flex-direction: row;\n            }\n          }\n          .khulnasoft-content-columns .column {\n            margin-bottom: 15px;\n          }\n          @media (max-width: 500px) {\n            .khulnasoft-content-columns .column {\n              margin-right: 0 !important;\n              margin-left: 0 !important;\n              width: 100% !important;\n            }\n          }\n          .khulnasoft-content-columns .image-container {\n            text-align: center;\n          }\n          .khulnasoft-content-columns .image {\n            margin: 0 auto 15px auto;\n            max-width: 100%;\n            display: block;\n          }\n          .khulnasoft-content-columns .button-container {\n            margin: auto;\n          }\n          .khulnasoft-content-columns .button {\n            display: inline-block;\n            margin-top: 15px;\n            min-width: 150px;\n            max-width: 100%;\n            text-align: center;\n            padding: 10px 20px;\n            max-width: 300px;\n            border: 1px solid black;\n          }\n          .khulnasoft-content-columns .separator {\n            margin-top: 15px;\n            background: black;\n            height: 5px;\n            width: 100px;\n            max-width: 100%;\n          }\n        "),
                react.createElement("div", { className: "khulnasoft-content-columns columns-container", style: { padding: this.gutterSize + "px " + this.gutterSize + "px 0 " + this.gutterSize + "px" } }, this.columns.map(function (column, index) {
                    var first = index === 0;
    ...
    var defaultHeroValues = {
        ...
        mainImage: 'https://khulnasoft.com/api/v1/image/assets%2FSiV2WLFdmvRvdlAcjQfpSMXMmgf1%2Fc1cf27e59be143e696e8484d5348c6a8',
        backgroundImage: 'https://khulnasoft.com/api/v1/image/assets%2FSiV2WLFdmvRvdlAcjQfpSMXMmgf1%2F9db794927ffd4438815962348648d965'
    };
    var heroInputs = [
    ...
    var ShopStyleHeroComponent = /** @class */ (function (_super) {
        ...
        ShopStyleHeroComponent.prototype.getImageUrl = function (baseUrl) {
            if (baseUrl.indexOf('khulnasoft.com') === -1) {
                return baseUrl;
            }
        ...
        ShopStyleHeroComponent.prototype.render = function () {
            var Fragment = react.Fragment;
            return (react.createElement(Fragment, null,
                react.createElement("style", { className: "khulnasoft-style khulnasoft-hero-style" }, "\n          .khulnasoft-content-hero.hero-content {\n            position: relative;\n            display: block;\n            overflow: hidden;\n            min-height: 300px;\n            padding: 10px;\n            background-color: white;\n            width: 100vw;\n            margin-left: calc(50% - 50vw);\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content {\n              padding: 20px 0;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .cta-button {\n            display: inline-block;\n            min-width: 85px;\n            padding: 0 10px;\n            margin-top: 15px;\n            overflow: hidden;\n            font-size: 12px;\n            line-height: 35px;\n            text-align: center;\n            text-overflow: ellipsis;\n            white-space: nowrap;\n            border: 1.5px solid black;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .light .cta-button {\n              border-color: white;\n            }\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .cta-button {\n              margin-top: 10px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .cta-button {\n              max-width: 100%;\n              min-width: 230px;\n              margin-top: 20px;\n              font-size: 18px;\n              line-height: 50px;\n              border-width: 3px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content,\n          .khulnasoft-content-hero.hero-content .content-container {\n            height: 350px;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content,\n            .khulnasoft-content-hero.hero-content .content-container {\n              height: 300px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content,\n            .khulnasoft-content-hero.hero-content .content-container {\n              height: 500px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .content-container {\n            position: relative;\n            display: flex;\n            height: 100%;\n            max-width: 1600px;\n            margin: auto;\n            color: black;\n            border: 1px solid #e4e4e4;\n            flex-direction: column-reverse;\n          }\n          .khulnasoft-content-hero.hero-content .content-container.light {\n            color: white;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .content-container {\n              border: none;\n              flex-direction: row;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .video {\n            position: absolute;\n            height: 100%;\n            min-width: 100%;\n            opacity: 0;\n            transition: opacity 0.2s;\n            object-position: center;\n            object-fit: cover;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .video {\n              width: 1600px;\n              margin-left: calc(50% - 800px);\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .video {\n              width: 1600px;\n              margin-left: calc(50% - 800px);\n            }\n          }\n          .khulnasoft-content-hero.hero-content .video.loaded {\n            opacity: 1;\n          }\n          .khulnasoft-content-hero.hero-content .inner-content {\n            display: flex;\n            width: 100%;\n            text-align: center;\n            background-position: center;\n            background-size: cover;\n          }\n          .khulnasoft-content-hero.hero-content .inner-content.text-side {\n            height: 180px;\n            color: black;\n            background-color: white;\n          }\n          .khulnasoft-content-hero.hero-content .inner-content.image-side {\n            position: relative;\n            height: 220px;\n            overflow: hidden;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .inner-content {\n              width: 50%;\n              background-position: center left;\n            }\n            .khulnasoft-content-hero.hero-content .inner-content.text-side {\n              height: auto;\n              color: inherit;\n              text-align: left;\n              background-color: transparent;\n              background-position: center right;\n            }\n            .khulnasoft-content-hero.hero-content .inner-content.image-side {\n              height: auto;\n            }\n          }\n          @media (max-width: 700px) {\n            .khulnasoft-content-hero.hero-content .inner-content.text-side {\n              background-image: none !important;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .subhead {\n            display: none;\n            color: #444;\n            text-transform: uppercase;\n          }\n          .khulnasoft-content-hero.hero-content .light .subhead {\n            color: white;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .subhead {\n              display: block;\n              margin-bottom: 10px;\n              font-size: 9px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .subhead {\n              margin-bottom: 15px;\n              font-size: 11px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .text-content {\n            position: relative;\n            width: 100%;\n            max-width: 580px;\n            max-height: 100%;\n            padding: 0 20px;\n            margin-left: auto;\n            overflow: hidden;\n            align-self: center;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .text-content {\n              padding: 0 20px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .text-content {\n              padding: 20px 50px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .heading {\n            font-size: 18px;\n            line-height: normal;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .heading {\n              font-size: 28px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .heading {\n              font-size: 54px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .subtext {\n            display: none;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .subtext {\n              display: block;\n              margin-top: 10px;\n              font-size: 12px;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .subtext {\n              margin-top: 20px;\n              font-size: 14px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .bar {\n            display: none;\n            vertical-align: middle;\n            background-color: black;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .bar {\n              display: inline-block;\n              width: 70px;\n              height: 3px;\n            }\n            .khulnasoft-content-hero.hero-content .light .bar {\n              background-color: white;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .bar {\n              width: 150px;\n              height: 5px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .secondary-link {\n            display: block;\n            padding: 10px;\n            text-align: center;\n            text-decoration: underline;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .secondary-link {\n              padding: 0;\n              margin-top: 10px;\n              text-align: left;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .secondary-link {\n              margin-top: 20px;\n            }\n          }\n          .khulnasoft-content-hero.hero-content .credit-text {\n            position: static;\n            display: none;\n            font-size: 10px;\n            color: #444;\n            text-align: center;\n          }\n          .khulnasoft-content-hero.hero-content .credit-text.outer {\n            display: block;\n            margin-top: 10px;\n          }\n          @media (min-width: 700px) {\n            .khulnasoft-content-hero.hero-content .credit-text {\n              position: absolute;\n              bottom: -15px;\n              left: 20px;\n              display: block;\n              text-align: left;\n            }\n            .khulnasoft-content-hero.hero-content .credit-text.outer {\n              display: none;\n            }\n          }\n          @media (min-width: 1600px) {\n            .khulnasoft-content-hero.hero-content .credit-text {\n              left: 5px;\n            }\n          }\n          "),
                react.createElement("div", { className: "khulnasoft-content-hero hero-content" },
    ...
    var KhulnasoftSpacerComponent = /** @class */ (function (_super) {
        __extends(KhulnasoftSpacerComponent, _super);
        function KhulnasoftSpacerComponent() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        KhulnasoftSpacerComponent.prototype.render = function () {
            return (react.createElement("div", { className: "khulnasoft-content-spacer", style: {
                    display: 'flex',
                    height: this.props.height,
                } }));
        };
        KhulnasoftSpacerComponent = __decorate([
            KhulnasoftBlock({
                name: 'Spacer',
                // tslint:disable-next-line:max-line-length
        ...
        ], KhulnasoftSpacerComponent);
        return KhulnasoftSpacerComponent;
    }(react.Component));

    var sizeNames = ['xsmall', 'small', 'medium', 'large'];
    // TODO: put in @khulnasoft.com/core
    var sizes = {
        xsmall: {
            min: 0,
            default: 0,
    ...
    var KhulnasoftStoreContext = react.createContext({
        state: {},
    ...
    var KhulnasoftAsyncRequestsContext = react.createContext({
        requests: [],
        errors: [],
        logs: []
    });
    ...
    var KhulnasoftBlock$1 = /** @class */ (function (_super) {
        __extends(KhulnasoftBlock, _super);
        function KhulnasoftBlock() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.privateState = {
                state: {},
                update: function () { }
        ...
        KhulnasoftBlock.prototype.stringToFunction = function (str) {
            // FIXME: gross hack
        ...
        Object.defineProperty(KhulnasoftBlock.prototype, "styles", {
            get: function () {
                ...
                var isServer = !Khulnasoft.isBrowser;
        ...
        Object.defineProperty(KhulnasoftBlock.prototype, "css", {
            get: function () {
                var self = this.props.block;
                var baseStyles = __assign$1({}, (self.responsiveStyles && self.responsiveStyles.large));
                var css = ".khulnasoft-block." + self.id + " {" + mapToCss(baseStyles) + "}";
                ...
                if (self.responsiveStyles) {
                    for (var _i = 0, reversedNames_1 = reversedNames; _i < reversedNames_1.length; _i++) {
                        ...
                        if (size !== 'large' &&
                            ...
                            css += "\n@media (max-width: " + sizes[size].max + "px) { \n.khulnasoft-block." + self.id + " {" + mapToCss(self.responsiveStyles[size], 4) + " } }";
                        }
                    }
                }
                return css;
        ...
        KhulnasoftBlock.prototype.componentDidMount = function () {
            var _this = this;
            ...
            if (animations) {
                ...
                Khulnasoft.animator.bindAnimations(options.animations.map(function (animation) { return (__assign$1({}, animation, { elementId: _this.props.block.id })); }));
            }
        };
        // <!-- Khulnasoft Blocks --> in comments hmm
        KhulnasoftBlock.prototype.getElement = function (index, state) {
            var _this = this;
            ...
            if (block.component && !block.component.class) {
                componentInfo = Khulnasoft.components.find(function (item) { return item.name === componentName; }) || null;
            ...
            var finalOptions = __assign$1({}, omit(options, 'class'), { class: "khulnasoft-block " + this.id + (block.class ? " " + block.class : '') + (block.component && !includes(['Image', 'Video', 'Banner'], componentName)
                    ? " khulnasoft-has-component"
                    : '') + (options.class ? ' ' + options.class : ''), key: this.id + index, 'khulnasoft-id': this.id });
            ...
            // TODO: test it out
            return (react.createElement(KhulnasoftAsyncRequestsContext.Consumer, null, function (value) {
                ...
                return (react.createElement(react.Fragment, null,
                    ...
                    react.createElement(InnerComponent, __assign$1({}, finalOptions, { khulnasoftBlock: block }))) : (react.createElement(TagName, __assign$1({}, finalOptions),
                        react.createElement(react.Fragment, null,
                            InnerComponent && (react.createElement(InnerComponent, __assign$1({ khulnasoftBlock: block }, innerComponentProperties))),
                            block.text || options.text ? (
                            // TODO: remove me! No longer in use (maybe with rich text will be back tho)
                            react.createElement(TextTag, { dangerouslySetInnerHTML: { __html: options.text || block.text } })) : block.children && block.children.length ? (block.children.map(function (block, index) { return (react.createElement(KhulnasoftBlock, { key: (_this.id || '') + index, block: block, index: index, size: _this.props.size, fieldName: _this.props.fieldName, child: _this.props.child })); })) : null))),
                    react.createElement("style", { className: "khulnasoft-style" }, (InnerComponent && !isBlock
                        ? "." + _this.id + " > * { height: 100%; width: 100%; }"
                        : '') + _this.css)));
            }));
        };
        Object.defineProperty(KhulnasoftBlock.prototype, "id", {
            get: function () {
                var block = this.props.block;
                if (!block.id.startsWith('khulnasoft')) {
        ...
        KhulnasoftBlock.prototype.contents = function (state) {
            var _this = this;
            var block = this.props.block;
            // this.setState(state);
            ...
            if (block.repeat && block.repeat.collection) {
                ...
                if (isArray(array)) {
                    return array.map(function (data, index) {
                        ...
                        return (react.createElement(KhulnasoftStoreContext.Provider, { value: __assign$1({}, state, { state: childState }) }, _this.getElement(index, childState)));
                    });
                }
                return null;
            }
        ...
        KhulnasoftBlock.prototype.render = function () {
            var _this = this;
            return (react.createElement(KhulnasoftStoreContext.Consumer, null, function (value) { return _this.contents(value); }));
        };
        return KhulnasoftBlock;
    }(react.Component));

    // TODO: options to set direciotn
    var KhulnasoftBlocks = /** @class */ (function (_super) {
        __extends(KhulnasoftBlocks, _super);
        function KhulnasoftBlocks() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.onClickEmptyBlocks = function () {
                if (Khulnasoft.isIframe && _this.noBlocks) {
                    window.parent.postMessage({
        ...
        Object.defineProperty(KhulnasoftBlocks.prototype, "isRoot", {
            get: function () {
        ...
        Object.defineProperty(KhulnasoftBlocks.prototype, "noBlocks", {
            get: function () {
        ...
        // <!-- Khulnasoft Blocks --> in comments hmm
        KhulnasoftBlocks.prototype.render = function () {
            var _this = this;
            var blocks = this.props.blocks;
            ...
            react.createElement("div", { className: 'khulnasoft-blocks' +
                    (this.noBlocks ? ' no-blocks' : '') +
                    (this.props.child ? ' khulnasoft-blocks-child' : '') +
                    (this.props.className ? ' ' + this.props.className : ''), "khulnasoft-type": "blocks", "khulnasoft-path": Khulnasoft.isIframe ? this.props.dataPath : undefined, style: __assign$1({ display: 'flex', flexDirection: 'column', alignItems: 'stretch' }, this.props.style), onClick: function () {
                    if (_this.noBlocks) {
                        _this.onClickEmptyBlocks();
                    }
                } }, blocks &&
                blocks.map(function (block, index) { return (react.createElement(KhulnasoftBlock$1, { key: block.id + index, block: block, index: index, fieldName: _this.props.fieldName, child: _this.props.child })); })));
        };
        return KhulnasoftBlocks;
    }(react.Component));
    ...
    var KhulnasoftContent = /** @class */ (function (_super) {
        __extends(KhulnasoftContent, _super);
        function KhulnasoftContent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.state = {
                loading: true,
                data: null
            ...
            _this.onClick = function (reactEvent) {
                ...
                if (khulnasoft.autoTrack) {
                    khulnasoft.trackInteraction(content.id, content.variationId, _this.clicked, event);
                }
                if (!_this.clicked) {
                    _this.clicked = true;
                }
        ...
        KhulnasoftContent.prototype.componentDidMount = function () {
            // Temporary to test metrics diving in with bigquery and heatmaps
            // khulnasoft.autoTrack = true;
            // khulnasoft.env = 'development';
            this.subscribeToContent();
        };
        KhulnasoftContent.prototype.subscribeToContent = function () {
            var _this = this;
            this.subscriptions.add(khulnasoft.queueGetContent(this.props.modelName, this.props.options).subscribe(function (matches) {
                var match = matches && matches[0];
                _this.setState({
                    data: match
                });
                if (match && _this.firstLoad) {
                    // TODO: autoTrack
                    if (khulnasoft.autoTrack) {
                        khulnasoft.trackImpression(match.id, match && match.variationId);
                    }
        ...
        KhulnasoftContent.prototype.componentWillUnmount = function () {
            this.subscriptions.unsubscribe();
        };
        KhulnasoftContent.prototype.render = function () {
            var _a = this.state, data = _a.data, loading = _a.loading;
            return (
            // TODO: tag instead?
            react.createElement("div", { className: "khulnasoft-content", onClick: this.onClick, "khulnasoft-content-id": this.state.data && this.state.data.id, "khulnasoft-model": this.props.modelName }, this.props.children(data && data.data, loading, data)));
        };
    ...
    var fetch$2 = Khulnasoft.isBrowser ? window.fetch : require('node-fetch');
    ...
    var KhulnasoftPage = /** @class */ (function (_super) {
        __extends(KhulnasoftPage, _super);
        function KhulnasoftPage(props) {
            ...
            _this.onContentLoaded = function (data) {
                ...
                if (data && data.jsCode && !Khulnasoft.isIframe) {
                ...
                if (data && (data.httpRequests || data.khulnasoftData) && !_this.props.noAsync) {
                    var _loop_1 = function (key) {
                    ...
                    for (var key in data.khulnasoftData) {
                        var url = data.khulnasoftData[key];
                        if (url && !_this.data[key]) {
                            _this.handleKhulnasoftRequest(key, _this.evalExpression(url));
                        }
                    }
                }
            };
        ...
        Object.defineProperty(KhulnasoftPage.prototype, "locationState", {
            get: function () {
        ...
        Object.defineProperty(KhulnasoftPage.prototype, "deviceSizeState", {
            // TODO: trigger state change on screen size change
            get: function () {
                // TODO: use context to pass this down on server
                return Khulnasoft.isBrowser ? sizes.getSizeForWidth(window.innerWidth) : 'large';
            },
            enumerable: true,
            configurable: true
        });
        // TODO: different options per device size...........................
        KhulnasoftPage.renderInto = function (elementOrSelector, props) {
            ...
            return reactDom.render(react.createElement(KhulnasoftPage, __assign$1({}, props)), element);
        };
        KhulnasoftPage.prototype.componentWillMount = function () {
        ...
        KhulnasoftPage.prototype.componentDidMount = function () {
            if (Khulnasoft.isIframe) {
                parent.postMessage({ type: 'khulnasoft.sdkInjected', data: { modelName: this.props.modelName } }, '*');
            }
        };
        KhulnasoftPage.prototype.processStateFromApi = function (state) {
            var _this = this;
            return mapValues(state, function (value) { return tryEval(value, _this.data, _this._errors); });
        };
        Object.defineProperty(KhulnasoftPage.prototype, "location", {
            get: function () {
                return this.props.location || (Khulnasoft.isBrowser ? location : {});
            },
            enumerable: true,
            configurable: true
        });
        KhulnasoftPage.prototype.getCssFromFont = function (font) {
        ...
        KhulnasoftPage.prototype.componentWillUnmount = function () {
            this.unsubscribe();
        };
        KhulnasoftPage.prototype.getFontCss = function (data) {
            var _this = this;
        ...
        KhulnasoftPage.prototype.getCss = function (data) {
            return (data.cssCode || '') + (this.getFontCss(data) || '');
        };
        Object.defineProperty(KhulnasoftPage.prototype, "data", {
            get: function () {
        ...
        KhulnasoftPage.prototype.render = function () {
            var _this = this;
            ...
            return (react.createElement(KhulnasoftAsyncRequestsContext.Consumer, null, function (value) {
                ...
                _this._errors = value && value.errors;
                _this._logs = value && value.logs;
                return (react.createElement(KhulnasoftStoreContext.Provider, { value: __assign$1({}, _this.state, { state: _this.data }) }, content ? (react.createElement(react.Fragment, null,
                    _this.getCss(content.data) && (react.createElement("style", { dangerouslySetInnerHTML: { __html: _this.getCss(content.data) } })),
                    react.createElement(KhulnasoftBlocks, { fieldName: "blocks", blocks: content.data.blocks }))) : (react.createElement(KhulnasoftContent
                // TODO: pass entry in
                , { 
                    // TODO: pass entry in
                    ...
                    return data ? (react.createElement("div", { "data-khulnasoft-component": _this.props.modelName, "data-khulnasoft-content-id": fullData.id, "data-khulnasoft-variation-id": fullData.variationId },
                        _this.getCss(data) && (react.createElement("style", { dangerouslySetInnerHTML: { __html: _this.getCss(data) } })),
                        react.createElement(KhulnasoftBlocks, { fieldName: "blocks", blocks: data.blocks }))) : loading ? (react.createElement("div", { "data-khulnasoft-component": _this.props.modelName, className: "khulnasoft-loading" })) : (react.createElement("div", { "data-khulnasoft-component": _this.props.modelName, className: "khulnasoft-no-content" }));
                }))));
            }));
        };
        KhulnasoftPage.prototype.evalExpression = function (expression) {
            var _this = this;
            var data = this.data;
            return expression.replace(/{{([^}]+)}}/g, function (match, group) { return tryEval(group, data, _this._errors); });
        };
        // TODO: customizable hm
        KhulnasoftPage.prototype.throttledHandleRequest = function (propertyName, url) {
            return this.handleRequest(propertyName, url);
        };
        KhulnasoftPage.prototype.handleRequest = function (propertyName, url) {
            return __awaiter(this, void 0, void 0, function () {
                var request, existing, promise_1, promise;
                var _this = this;
                return __generator(this, function (_a) {
                    // TODO: Khulnasoft.isEditing = just checks if iframe and parent page is khulnasoft.com or localhost:1234
        ...
        KhulnasoftPage.prototype.unsubscribe = function () {
            if (this.subscriptions) {
                this.subscriptions.unsubscribe();
                this.subscriptions = new Subscription();
            }
        };
        KhulnasoftPage.prototype.handleKhulnasoftRequest = function (propertyName, optionsString) {
            var _this = this;
            ...
            if (options) {
                ...
                this.subscriptions.add(khulnasoft.queueGetContent(options.model, options).subscribe(function (matches) {
                    if (matches) {
                        _this.updateState(function (ctx) {
        ...
        ], KhulnasoftPage.prototype, "throttledHandleRequest", null);
        return KhulnasoftPage;
    }(react.Component));

    // TODO: docs
    var KhulnasoftSimpleComponent = /** @class */ (function (_super) {
        __extends(KhulnasoftSimpleComponent, _super);
        function KhulnasoftSimpleComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.state = {
                data: null,
                classes: []
            ...
            _this.onClick = function (event) {
                if (khulnasoft.canTrack) {
                    ...
                    if (data) {
                        khulnasoft.trackInteraction(data.id, data.testVariationId || data.id, _this.trackedClick, event.nativeEvent);
        ...
        KhulnasoftSimpleComponent.prototype.addClass = function (className) {
            if (this.state.classes.indexOf(className) === -1) {
                this.setState(__assign$1({}, this.state, { classes: this.state.classes.concat([className]) }));
            }
        };
        KhulnasoftSimpleComponent.prototype.removeClass = function (className) {
        ...
        KhulnasoftSimpleComponent.prototype.componentWillUnmount = function () {
            this.unsubscribe();
        };
        KhulnasoftSimpleComponent.prototype.componentDidMount = function () {
            this.getContent();
        };
        KhulnasoftSimpleComponent.prototype.disconnectedCallback = function () {
            this.unsubscribe();
        };
        KhulnasoftSimpleComponent.prototype.componentWillUpdate = function (props) {
            if (props.name !== this.props.name || props.entry !== this.props.entry) {
                // TODO: more options too
                this.getContent();
            }
        };
        KhulnasoftSimpleComponent.prototype.loaded = function () {
            this.addClass('khulnasoft-loaded');
        };
        KhulnasoftSimpleComponent.prototype.getContent = function () {
            var _this = this;
            ...
            if (!khulnasoft.apiKey) {
                var subscription_1 = khulnasoft['apiKey$'].subscribe(function (key) {
                    if (key) {
                        _this.getContent();
                    }
                });
            ...
            var subscription = khulnasoft
                ...
                _this.removeClass('khulnasoft-loading');
                _this.loaded();
                _this.addClass('khulnasoft-no-content-found');
                if (!data) {
                ...
                if (_this.ref && _this.ref.classList.contains('khulnasoft-editor-injected')) {
                    _this.unsubscribe();
                }
                else {
                ...
                _this.addClass('khulnasoft-errored');
                _this.addClass('khulnasoft-loaded');
                _this.removeClass('khulnasoft-loading');
        ...
        KhulnasoftSimpleComponent.prototype.unsubscribe = function () {
            if (this.subscriptions) {
                this.subscriptions.forEach(function (fn) { return fn(); });
                this.subscriptions = [];
            }
        };
        KhulnasoftSimpleComponent.prototype.render = function () {
            var _this = this;
            var html = this.props.html ||
                (this.state && this.state.data && this.state.data.data && this.state.data.data.html);
            return (react.createElement("div", { "khulnasoft-model": this.props.name, ref: function (ref) { return (_this.ref = ref); }, className: this.state.classes.join(' '), dangerouslySetInnerHTML: html && { __html: html } }));
        };
        return KhulnasoftSimpleComponent;
    }(react.Component));

    var iconUrl = 'https://firebasestorage.googleapis.com/v0/b/khulnasoft-3b0a2.appspot.com/o/images%2Fbaseline-text_fields-24px%20(1).svg?alt=media&token=12177b73-0ee3-42ca-98c6-0dd003de1929';
    var Text = /** @class */ (function (_super) {
        ...
        Text.prototype.render = function () {
            return (react.createElement(react.Fragment, null,
                react.createElement("style", null, ".khulnasoft-text p:first-child, .khulnasoft-paragraph:first-child { margin: 0 } .khulnasoft-text > p, .khulnasoft-paragraph { color: inherit; line-height: inherit; letter-spacing: inherit; font-weight: inherit; font-size: inherit; text-align: inherit; font-family: inherit; }"),
                react.createElement("div", { "khulnasoft-text": "true", className: "khulnasoft-text", dangerouslySetInnerHTML: { __html: this.props.text || this.props.content || '' } })));
        };
        Text = __decorate([
            KhulnasoftBlock({
                name: 'Text',
    ...
    var Columns = /** @class */ (function (_super) {
        ...
        Columns.prototype.render = function () {
            ...
            react.createElement(react.Fragment, null,
                react.createElement("style", null, "\n            .khulnasoft-columns {\n              display: flex;\n            }\n\n            .khulnasoft-column {\n              line-height: normal;\n            }\n\n            .khulnasoft-column > .khulnasoft-blocks {\n              flex-grow: 1;\n            }\n          "),
                react.createElement("style", null, "\n          @media (max-width: " + (this.props.stackColumnsAt !== 'tablet' ? 639 : 999) + "px) {\n            ." + this.props.khulnasoftBlock.id + " > .khulnasoft-columns {\n              flex-direction: " + (this.props.reverseColumnsWhenStacked ? 'column-reverse' : 'column') + ";\n              align-items: stretch;\n            }\n\n            ." + this.props.khulnasoftBlock.id + " > .khulnasoft-columns > .khulnasoft-column {\n              width: 100% !important;\n              margin-left: 0 !important;\n            }\n          }\n        "),
                react.createElement("div", { className: "khulnasoft-columns", style: { display: 'flex' } }, columns.map(function (col, index) {
                    var TagName = col.link ? 'a' : 'div';
                    return (react.createElement(TagName, __assign$1({ key: index, className: "khulnasoft-column" }, (col.link ? { href: col.link } : null), { style: {
                        ...
                        react.createElement(KhulnasoftBlocks, { key: index, 
                            // TODO: childOf [parentBlocks]?
                            child: true, parentElementId: _this.props.khulnasoftBlock && _this.props.khulnasoftBlock.id, blocks: col.blocks, dataPath: "component.options.columns." + index + ".blocks" })));
                }))));
        };
        Columns = __decorate([
            KhulnasoftBlock({
    ...
    var Embed = /** @class */ (function (_super) {
        ...
        Embed.prototype.render = function () {
            return (react.createElement("div", { className: "khulnasoft-embed", dangerouslySetInnerHTML: { __html: this.props.content } }));
        };
        Embed = __decorate([
            KhulnasoftBlock({
                name: 'Embed',
    ...
    var CustomCode = /** @class */ (function (_super) {
        ...
        CustomCode.prototype.render = function () {
            return (react.createElement("div", { className: "khulnasoft-custom-code", dangerouslySetInnerHTML: { __html: this.props.code } }));
        };
    ...
    var Image = /** @class */ (function (_super) {
        ...
        Image.prototype.render = function () {
            var _a = this.props, aspectRatio = _a.aspectRatio, khulnasoftBlock = _a.khulnasoftBlock;
            ...
            react.createElement(react.Fragment, null,
                react.createElement("img", { alt: this.props.altText, height: this.props.height, width: this.props.width, role: !this.props.altText ? 'presentation' : undefined, style: __assign$1({ objectFit: this.props.backgroundSize, 
                        ...
                        left: 0,
                        top: 0
                    })), className: "khulnasoft-image", src: this.props.image }),
        ...
        Image = __decorate([
            KhulnasoftBlock({
                name: 'Image',
                image: 'https://firebasestorage.googleapis.com/v0/b/khulnasoft-3b0a2.appspot.com/o/images%2Fbaseline-insert_photo-24px.svg?alt=media&token=4e5d0ef4-f5e8-4e57-b3a9-38d63a9b9dc4',
                defaultStyles: {
                    minHeight: '20px',
                    minWidth: '20px',
                    overflow: 'hidden'
                ...
                inputs: [
                    {
                        ...
                        defaultValue: 'https://khulnasoft.com/api/v1/image/assets%2Fpwgjf0RoYWbdnJSbpBAjXNRMe9F2%2Ffb27a7c790324294af8be1c35fe30f4d',
                        onChange: function (options) {
    ...
    var Video = /** @class */ (function (_super) {
        ...
        Video.prototype.render = function () {
            ...
            return (react.createElement("div", { style: { position: 'relative', fontSize: 0 } },
                react.createElement("video", { poster: this.props.posterImage, height: this.props.height || '100%', width: this.props.width || '100%', ref: function (ref) { return (_this.video = ref); }, autoPlay: this.props.autoPlay, 
                    ...
                    muted: this.props.muted, controls: this.props.controls, loop: this.props.loop, className: "khulnasoft-video", 
                    // type="video/mp4"
        ...
        Video = __decorate([
            KhulnasoftBlock({
                name: 'Video',
                image: 'https://firebasestorage.googleapis.com/v0/b/khulnasoft-3b0a2.appspot.com/o/images%2Fbaseline-videocam-24px%20(1).svg?alt=media&token=49a84e4a-b20e-4977-a650-047f986874bb',
                inputs: [
                    {
                        name: 'video',
                        type: 'file',
                        allowedFileTypes: ['mp4'],
                        defaultValue: 'https://firebasestorage.googleapis.com/v0/b/khulnasoft-3b0a2.appspot.com/o/assets%2FKQlEmWDxA0coC3PK6UvkrjwkIGI2%2F28cb070609f546cdbe5efa20e931aa4b?alt=media&token=912e9551-7a7c-4dfb-86b6-3da1537d1a7f',
                        required: true,
                        onChange: function (options) {
                            var DEFAULT_ASPECT_RATIO = 0.7004048582995948;
                            function loadImage(url, timeout) {
    ...
    exports.KhulnasoftPage = KhulnasoftPage;
    exports.KhulnasoftComponent = KhulnasoftPage;
    exports.khulnasoft = khulnasoft;
    exports.Khulnasoft = Khulnasoft;
    exports.default = khulnasoft;
    exports.KhulnasoftBlocks = KhulnasoftBlocks;
    exports.KhulnasoftContent = KhulnasoftContent;
    exports.KhulnasoftSimpleComponent = KhulnasoftSimpleComponent;
    exports.KhulnasoftStoreContext = KhulnasoftStoreContext;
    exports.KhulnasoftAsyncRequestsContext = KhulnasoftAsyncRequestsContext;
    exports.KhulnasoftBlock = KhulnasoftBlock;
    exports.Text = Text;
...
//# sourceMappingURL=khulnasoft-react.umd.js.map
