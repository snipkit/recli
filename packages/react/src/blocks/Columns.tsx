...
const defaultBlocks: KhulnasoftElement[] = [
  {
...
class ColumnsComponent extends React.Component<any> {
  ...
  render() {
    ...
    const contentBreakpoints: Breakpoints =
      this.props.khulnasoftState?.context.khulnasoftContent?.meta?.breakpoints || {};
...
export const Columns = withKhulnasoft(ColumnsComponent, {
  name: 'Columns',
  static: true,
  inputs: [
    {
