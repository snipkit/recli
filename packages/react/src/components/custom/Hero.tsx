...
import { Input as KhulnasoftInput } from '@khulnasoft.com/sdk'
...
export const defaultHeroValues: HeroProps = {
  ...
  mainImage:
    'https://khulnasoft.com/api/v1/image/assets%2FSiV2WLFdmvRvdlAcjQfpSMXMmgf1%2Fc1cf27e59be143e696e8484d5348c6a8',
  backgroundImage:
    'https://khulnasoft.com/api/v1/image/assets%2FSiV2WLFdmvRvdlAcjQfpSMXMmgf1%2F9db794927ffd4438815962348648d965'
}

export const heroInputs: KhulnasoftInput[] = [
...
export class ShopStyleHeroComponent extends React.Component<HeroProps> {
  ...
  render() {
    ...
    return (
      <Fragment>
        <style className="khulnasoft-style khulnasoft-hero-style">
          {`
        ...
        <div className="khulnasoft-content-hero hero-content">
