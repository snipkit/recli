...
describe('Image', () => {
  it('Khulnasoft image url', () => {
    const tree = reactTestRenderer
      .create(
        <Image image="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F755c131471fb49ab91dc0bdc45bc85b5?width=1003" />
      )
      .toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('Khulnasoft image url with width', () => {
    const tree = reactTestRenderer
      .create(
        <Image image="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F755c131471fb49ab91dc0bdc45bc85b5?width=1003" />
      )
  ...
  it('Lazy load', () => {
    const tree = reactTestRenderer
      .create(
        <Image
          image="https://cdn.khulnasoft.com/api/v1/image/assets%2FYJIGb4i01jvw0SRdL5Bt%2F755c131471fb49ab91dc0bdc45bc85b5?width=1003"
          lazy
        />
      )
      .toJSON();
