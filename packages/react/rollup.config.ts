...
export default [
  ...
  // {
  //   ...options,
  //   output: { file: './dist/system.js', format: 'system', name: '@khulnasoft.com/react', sourcemap: true },
  //   external: ['react', '@khulnasoft.com/sdk'],
  ...
  {
    ...options,
    output: { file: pkg.unpkg, format: 'iife', name: 'KhulnasoftReact', sourcemap: true }
  }
]
